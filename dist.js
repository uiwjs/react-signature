...
var _excluded=["className","prefixCls","style","onPointer","options"];var points=[];var Signature=/*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef)(function(props,ref){var className=props.className,_props$prefixCls=props.prefixCls,prefixCls=_props$prefixCls===void 0?'w-signature':_props$prefixCls,style=props.style,onPointer=props.onPointer,options=props.options,others=_objectWithoutProperties(props,_excluded);var cls=[className,prefixCls].filter(Boolean).join(' ');var $svg=(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null);var $path=(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)();(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useImperativeHandle)(ref,function(){return $svg.current;},[$svg.current]);var handlePointerDown=function handlePointerDown(e){var _getBoundingClientRec=getBoundingClientRect($svg.current),offsetY=_getBoundingClientRec.offsetY,offsetX=_getBoundingClientRec.offsetX;var clientX=e.clientX||e.nativeEvent.clientX;var clientY=e.clientY||e.nativeEvent.clientY;points=[[clientX-offsetX,clientY-offsetY]];var pathElm=document.createElementNS('http://www.w3.org/2000/svg','path');$path.current=pathElm;$svg.current.appendChild(pathElm);// $svg.current?.remove()
};var handlePointerMove=function handlePointerMove(e){if($path.current){var _$path$current;var _getBoundingClientRec2=getBoundingClientRect($svg.current),offsetY=_getBoundingClientRec2.offsetY,offsetX=_getBoundingClientRec2.offsetX;var _getClinetXY=getClinetXY(e),clientX=_getClinetXY.clientX,clientY=_getClinetXY.clientY;points=[].concat(_toConsumableArray(points),[[clientX-offsetX,clientY-offsetY]]);var stroke=ae(points,_objectSpread2(_objectSpread2({},defaultOptions),options));var pathData=getSvgPathFromStroke(stroke);(_$path$current=$path.current)===null||_$path$current===void 0?void 0:_$path$current.setAttribute('d',pathData);}};var handlePointerUp=function handlePointerUp(){onPointer&&onPointer(points);points=[];$path.current=undefined;};(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useEffect)(function(){document.addEventListener('pointermove',handlePointerMove);document.addEventListener('pointerup',handlePointerUp);return function(){document.removeEventListener('pointermove',handlePointerMove);document.removeEventListener('pointerup',handlePointerUp);};},[]);return/*#__PURE__*/(0,jsx_runtime.jsx)("svg",_objectSpread2(_objectSpread2({},others),{},{ref:$svg,className:cls,onPointerDown:handlePointerDown,style:_objectSpread2(_objectSpread2({},defaultStyle),style)}));});/* harmony default export */ const src = (Signature);
})();
