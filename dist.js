...
var Paths_excluded=["options"],_excluded2=["renderPath"];var Paths=function Paths(){var _useStore=useStore(),options=_useStore.options,data=_objectWithoutProperties(_useStore,Paths_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(external_root_React_commonjs2_react_commonjs_react_amd_react_.Fragment,{children:Object.keys(data).map(function(key,index){return/*#__PURE__*/(0,jsx_runtime.jsx)(CreatePath,{keyName:key,index:index,data:data[key]},key);})});};var CreatePath=function CreatePath(_ref){var _ref$data=_ref.data,data=_ref$data===void 0?[]:_ref$data,index=_ref.index,keyName=_ref.keyName;var _useOptionStore=useOptionStore(),renderPath=_useOptionStore.renderPath,options=_objectWithoutProperties(_useOptionStore,_excluded2);var stroke=ae(data,options);var pathData=getSvgPathFromStroke(stroke);var dom=renderPath?renderPath(pathData,keyName,data,index):null;if(dom)return dom;return/*#__PURE__*/(0,jsx_runtime.jsx)("path",{d:pathData});};
